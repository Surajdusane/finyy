    ...
    <Card className="border-none drop-shadow-sm -mt-24">
      <CardHeader className="gap-y-2 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-col lg:flex-row gap-y-2 items-center gap-x-2">
          <Button className="w-full lg:w-auto" onClick={onCancel} size="sm" variant={"destructive"}>
            Cancel
          </Button>
          <Button onClick={handleContinue} className="w-full lg:w-auto" size={"sm"} disabled={progress < requiredOptions.length}>
